...
export interface Config {
  ...
  jobs: {
    tasks: {
      demoSendEmail: TaskDemoSendEmail;
      inline: {
        input: unknown;
        output: unknown;
      };
...
export interface ProductsBlock {
  ...
  pickedProducts?: (string | Product)[] | null;
  id?: string | null;
  blockName?: string | null;
  blockType: 'products';
}
...
export interface Category {
  ...
  title: string;
  /**
   * Optional parent category to create nested category trees.
   */
...
export interface PayloadJob {
  ...
  log?:
    ...
    | null;
  taskSlug?: ('inline' | 'demoSendEmail') | null;
  queue?: string | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "TaskDemoSendEmail".
 */
export interface TaskDemoSendEmail {
  input: {
    userEmail: string;
  };
  output: {
